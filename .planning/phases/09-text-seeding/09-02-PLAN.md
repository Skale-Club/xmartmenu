...
<task type="auto">
  ...
  <acceptance_criteria>
    ...
    - File contains `service.from('products').insert(` (products table write — AI-03)
    - File contains `service.from('tenant_settings').upsert(` (copy write — AI-04)
...
6. `grep "from('products')" src/app/api/superadmin/tenants/[id]/seed/route.ts` returns match
7. `grep "from('tenant_settings')" src/app/api/superadmin/tenants/[id]/seed/route.ts` returns match
