...
- [x] 10-02-PLAN.md — GH Actions: image-seeding.yml workflow + scripts/seed-images.ts generation script
- [x] 10-03-PLAN.md — Vercel routes + UI: seed-images trigger route, seed-status polling route, TenantDetailClient image seeding section
**UI hint**: yes
