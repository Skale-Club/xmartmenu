...
- [x] **Phase 11: Menu Photo OCR** — Superadmin can upload a photo of a tenant's physical menu; GPT-4.1-mini extracts categories, items, and prices and writes them directly to the tenant's tables (completed 2026-05-07)
...
**Goal**: Superadmin can trigger image seeding for a tenant — generating a cover photo via gpt-image-1-mini and sourcing per-product stock photos from Pexels/Unsplash — all uploaded directly to Supabase Storage as WebP
**Depends on**: Phase 9
**Requirements**: AI-07, AI-08, AI-09
**Success Criteria** (what must be TRUE):
  1. Superadmin triggers image seeding; a cover photo generated by gpt-image-1-mini is uploaded as the tenant's cover image
  2. Each product without an image gets a Pexels/Unsplash stock photo uploaded as its `image_url`
